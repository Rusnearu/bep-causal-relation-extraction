...
class Trainer(object):
    ...
    def evaluate(self, mode):
        ...
        pred_labels = [self.label_lst[p] for p in preds]
        true_labels = [self.label_lst[l] for l in out_label_ids]

        os.makedirs(self.args.eval_dir, exist_ok=True)
        with open(os.path.join(self.args.eval_dir, "predictions.txt"), "w", encoding="utf-8") as f:
